                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Ingrese Codigo Y Nombre del Profesor</h4>
                                                ...
                                                <div class="modal-body">
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" type="text" id="nObligatoria"
                                                            name="nObligatoria" placeholder="Ingrese CODIGO" requiered
                                                            /">
                                                        <input class="form-control" type="text" id="obligatoria"
                                                            name="obligatoria" placeholder="Ingrese NOMBRE" requiered
                                                            /">
                                                    </div>
                                                </div>
                                                <!--Footer-->
