...
<body>
    ...
    <main>
        ...
        <div class="row">
            <div class="col-8">
                <h1>Base de datos de alumnos inscritos</h1>
            </div>
            <div class="col-3">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form method="POST" action="logicaAlumno/guardarAlumno.php">
                                    <div class="mb-3">
            ...
            <div class="modal fade" id="eliminarAlumno" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <!-- Formulario accion="funcion.php" para realizar las tareas, methodo="get, post" importar en la hoja arriba y abajo en action llamo a la funcion-->
                                <form method="DELETE" action="logicaAlumno/eliminarAlumno.php">
                                    <div class="mb-3">
                                        <label for="rut" class="form-label">RUT DEL ALUMNO</label>
                                        <input name="rut" type="text" class="form-control">
                                    </div>
                            </div>
                            <div class="modal-footer">
            ...
            <div class="modal fade" id="editarAlumno" tabindex="-1" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <!-- Formulario accion="funcion.php" para realizar las tareas, methodo="get, post" importar en la hoja arriba y abajo en action llamo a la funcion-->
                                <form method="POST" action="logicaAlumno/editarAlumno.php">
                                <div class="mb-3">
                                        <label for="rut" class="form-label">RUT ALUMNO</label>
                                        <input name="rut" type="text" class="form-control">
                                    </div>
        ...
        <table class="table">
            ...
            <tbody>
                <?php
				$query = $bdd->query("SELECT * FROM alumno");
				if($query->num_rows > 0){
